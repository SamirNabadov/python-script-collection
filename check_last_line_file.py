...
def main():
    ...
    last_lines = get_last_n_lines('E:\\samir\\devops\\python\\scripts\\kube.sh', 3)
    ...
    last_lines = get_last_n_lines('E:\\samir\\devops\\python\\scripts\\kube.sh', 5)
    ...
    last_lines = get_last_n_lines('E:\\samir\\devops\\python\\scripts\\kube.sh', 1)
    ...
    if sub_string_to_match in get_last_n_lines('E:\\samir\\devops\\python\\scripts\\kube.sh', 1)[0]:
